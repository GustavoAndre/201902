...
{
    public partial class frmReportexMes : Form
    {
        
        public frmReportexMes()
        {
            InitializeComponent();
            LLenarComboAño();
        }
        ...
        void MostrarReportexPedido(String vMes)
        {
            ...
            try
            {
                ...
                oPvCollection.Clear();
                frmReportes.CR_PedidosxMes rpv = new frmReportes.CR_PedidosxMes();
                rpv.SetParameterValue("@Mes", vMes);
                rpv.SetParameterValue("@Año", cboAño.SelectedItem);
                crvReportePedidosxMes.ReportSource = rpv;
            }
        ...
        private void FrmReportexMes_Load(object sender, EventArgs e)
        {
        ...
        {
            //label1.Text = cboAño.SelectedItem.ToString();
        }
    }
}
